...
from fun2.utils import rotate_point, inside_rotated_box, compute_mean_intensity, generate_box
...
class SoNCalculator:
    ...
    def __init__(self, matrix_path: str, control_matrix_path: str = None, weight_name: str = None, chrom_size_path: str = None, output: str = None,
                 height: int = 200, width: int = 5, angle: float = 45, resolution = 5000):
        """
    ...
    def calculate_SoN_all_chromosomes(self) -> tuple:
        ...
        for chrom in self.chrom_sizes.keys():
            ...
            summits_df, regions_df = self._format_summits_df(SoN_vals, chrom)
